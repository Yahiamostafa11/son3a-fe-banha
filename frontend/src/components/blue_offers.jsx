    ...
    <section className="monthly-offers-section">
      <div className="offers-container" style={{ backgroundColor: '#2563eb' }}>
        <div className="character-side">
          <img src={blueBoy} alt="شخصية هندسية" className="painter-character reveal-left" />
        </div>
        <div className="content-side reveal-right">
          ...
          <button className="buy-now-btn" style={{ backgroundColor: '#1d4ed8' }}>{t('dept_offers_btn')}</button>
