...
function BlueFooter() {
  const testimonials = [
    ...
    },
    {
      ...
      bg: 'orange', // سنعطيه خلفية زرقاء هنا عبر الـ Inline Style لحماية المظهر
  ...
  return (
    <div className="footer-section-wrapper">
        ...
        <div className="masonry-grid">
          {testimonials.map(item => (
            <div 
              ...
              style={item.bg === 'orange' ? { background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)' } : {}}
            >
      ...
      <footer className="main-footer">
        ...
        <div className="footer-copyright">جميع الحقوق محفوظة @ madeinBenha</div>
      </footer>
    </div>
  )
}
